  ...
  return <>
    ...
    <section className="card" style={{ marginBottom:22 }}>
      ...
      <form action={createProductAction} className="form-grid">
        ...
        <div className="field"><label>Preço de venda (R$)</label><input className="input" name="price" type="number" min="0" step="0.01" required/></div>
        <div className="field"><label>Custo por unidade (R$)</label><input className="input" name="cost" type="number" min="0" step="0.01" required/><small>Informe o custo de uma unidade vendida deste produto.</small></div>
