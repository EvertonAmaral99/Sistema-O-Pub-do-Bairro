  ...
  return <>
    ...
    <section className="card product-edit-card">
      <form action={updateProductAction} className="form-grid">
        ...
        <ProductStockFields mode="edit" options={stockOptions} currentPoolId={product.stock_pool_id} initialLinkedProductId={product.shared_with_product_id} initialSaleUnit={product.sale_unit} storedStockFactor={product.stock_per_sale_unit} initialStock={product.stock_quantity} initialMinStock={product.min_stock} initialUnlimited={product.stock_unlimited}/>
