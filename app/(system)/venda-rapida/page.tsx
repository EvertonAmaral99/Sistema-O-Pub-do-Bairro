...
export default async function QuickSalePage(){
  ...
  const [products,staffMembers,customers,cash]=await Promise.all([
  ...
  return <>
    ...
    <QuickSaleWorkspace products={products.rows} staffMembers={staffMembers.rows} customers={customers.rows} cashOpen={cashOpen}/>
  </>;
}
